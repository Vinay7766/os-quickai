 ...
 */
export function BrowserPanel({ browser, searchEngine, llmModel, availableModels, updateSetting, onBack }: BrowserPanelProps) {
  const allModels = Array.from(new Set(['free-model', ...availableModels]));
  return (
