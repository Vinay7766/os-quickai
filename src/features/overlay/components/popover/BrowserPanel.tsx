...
export function BrowserPanel({ 
  browser, searchEngine, llmModel, availableModels, updateSetting, onBack 
}: BrowserPanelProps) {
  return (
    <div className="flex flex-col p-4 w-full overflow-y-auto scrollbar-thin max-h-[360px]">
      <div className="flex items-center gap-2 mb-3 shrink-0">
        ...
        <span className="text-[10px] font-black uppercase tracking-wider text-white">Browser, Search & AI</span>
      </div>
        ...
        <div>
          ...
          <div className="relative">
            <select
              ...
              style={{ background: 'rgba(0, 0, 0, 0.4)' }}
            >
              <option value="free-model" className="bg-[#1c1c1c] text-white">Free Model (Default)</option>
